...
from lib_v8 import wg_width, radius, dr
from lib_v8 import RF_PAD_PITCH, RF_PAD_GAP, SIG_width, GAP_width, RF_PAD_size, RF_GND_taper_length, RF_SIG_taper_length, RF_PAD_taper_end
