...
from lib_v7 import wg_width, radius, dr
from lib_v7 import RF_PAD_PITCH, RF_PAD_GAP, SIG_width, GAP_width, RF_PAD_size, RF_GND_taper_length, RF_SIG_taper_length, RF_PAD_taper_end
...
def new_RF_PAD_cell():
	ret_cell = gdstk.Cell("RF_PAD_TEST")
	origin=(0,0)
	# GSGSG pad
	for i in range(5):
		pad_offset = i - 2
